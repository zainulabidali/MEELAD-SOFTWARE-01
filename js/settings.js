    ...
    container.innerHTML = `
        <div class="settings-grid">
            ...
            <div class="card settings-bottom-card" style="margin-top: 0;">
                <div class="settings-header-section" style="display:flex; align-items:center; gap:0.5rem; margin-bottom:1rem; border-bottom:1px solid #D8E8DE; padding-bottom:0.75rem;">
                    <span style="font-size:1.5rem;">⚙️</span>
                    <h3 style="margin:0; font-size:1.15rem; font-weight:800; color:#17251B;">Event Information</h3>
                </div>
                <p style="font-size:0.75rem; color:#64756A; margin-top:-0.5rem; margin-bottom:1.5rem;">Configure the public portal brand parameters and event metadata details.</p>
                ...
                <form id="eventSettingsForm" style="display:flex; flex-direction:column; gap:1rem;">
                    ...
                    <div class="form-group-compact">
                        ...
                        <div style="display:flex; align-items:center; gap:1rem; margin-top:0.35rem; background:#F5FAF7; padding:0.75rem; border:1px dashed #D8E8DE; border-radius:8px;">
                            <div id="eventLogoPreviewContainer" style="width:70px; height:70px; border-radius:8px; border:1px solid #D8E8DE; background:#ffffff; display:flex; align-items:center; justify-content:center; overflow:hidden; position:relative; flex-shrink:0;">
                                ${localConfig.eventLogo ? `<img id="eventLogoPreviewImg" src="${localConfig.eventLogo}" style="max-width:100%; max-height:100%; object-fit:contain;" />` : `<span id="eventLogoPlaceholder" style="font-size:0.7rem; color:#64756A; text-align:center; padding:2px;">No Logo</span>`}
                            </div>
                            <div style="display:flex; flex-direction:column; gap:0.4rem; flex:1;">
                                ...
                                <span style="font-size:0.7rem; color:#64756A;">Accepts PNG only (max 2MB)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="display:flex; gap:0.75rem; border-top:1px solid #D8E8DE; padding-top:1rem; margin-top:0.5rem;">
            ...
            <div class="settings-bottom-card" style="border: none !important; background: transparent !important; box-shadow: none !important; padding: 0 !important; margin-top: 1rem; margin-bottom: 0.25rem;">
                <h3 style="font-size:1.15rem; font-weight:800; color:#17251B; margin:0; display:flex; align-items:center; gap:0.5rem;">
                    🛠️ Management Settings
                </h3>
                <p style="font-size:0.75rem; color:#64756A; margin:0.25rem 0 0 0;">Manage student entry limits and award-points allocation parameters.</p>
            </div>
            ...
            <div class="card settings-left-card" style="margin-top: 0; min-height: 140px; display:flex; flex-direction:column; justify-content:space-between;">
                <div>
                    <h3 style="font-size:1rem; font-weight:800; color:#17251B; display:flex; align-items:center; gap:0.4rem; margin:0;">
                        🎯 Student Participation Limits
                    </h3>
                    <p style="font-size:0.75rem; color:#64756A; margin-top:0.5rem; margin-bottom:1rem; line-height:1.4;">
            ...
            <div class="card settings-bottom-card" style="margin-top: 1rem; border: 1px solid #D8E8DE; background: #ffffff;">
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:1rem;">
                    <div>
                        <h3 style="font-size:1.05rem; font-weight:800; color:#17251B; display:flex; align-items:center; gap:0.4rem; margin:0;">
                            💰 Finance Management
                        </h3>
                        <p style="font-size:0.75rem; color:#64756A; margin:0.25rem 0 0 0;">
            ...
            <div class="card settings-bottom-card" style="margin-top: 1rem; border: 1px solid #fee2e2; background: #fff5f5;">
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:1rem;">
                    <div>
                        <h3 style="font-size:1.05rem; font-weight:800; color:#EF4444; display:flex; align-items:center; gap:0.4rem; margin:0;">
                            ⚠ Danger Zone
                        </h3>
                    ...
                    <button type="button" id="btnOpenDangerZone" class="btn btn-danger btn-sm" style="font-weight:700; font-size:0.78rem; padding:0.45rem 1.25rem; background:#EF4444; border-color:#EF4444; color:#ffffff;">Open Danger Zone</button>
                </div>
            </div>
        </div>
    `;
...
function renderPointsManagementCardHTML() {
    return `
        ...
        <div class="card settings-bottom-card" style="margin-top: 0.5rem; margin-bottom: 0.5rem;">
            <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid #D8E8DE; padding-bottom:0.75rem; margin-bottom:1rem;">
                <h3 style="font-size:1.05rem; font-weight:800; color:#17251B; display:flex; align-items:center; gap:0.4rem; margin:0;">
                    ⚙️ Point Management
                </h3>
            </div>
            <p style="font-size:0.75rem; color:#64756A; margin-top:-0.5rem; margin-bottom:1.25rem;">
...
async function openPointManageModal() {
    ...
    modalBody.innerHTML = `
        <div style="text-align:center;padding:3rem;">
            ...
            <p style="margin-top:1rem;color:#64756A;font-weight:600;">Loading grade and point rules...</p>
        </div>
    `;
        ...
        const renderModalUI = () => {
            const renderGradeRowsHTML = () => {
                if (currentGrades.length === 0) {
                    return `<tr><td colspan="5" style="text-align:center; padding:2rem; color:#64756A;">No grades defined yet. Click <strong>+ Add Grade</strong> to define one.</td></tr>`;
                }

                return currentGrades.map((g, idx) => `
                    <tr style="border-bottom: 1px solid #ECFDF5; transition: background 0.15s;" onmouseover="this.style.background='#F5FAF7'" onmouseout="this.style.background='transparent'">
                        <td style="padding: 0.75rem 1rem; font-weight: 700;">
                            <span class="badge" style="background:#e0e7ff; color:#064E3B; border:1px solid #ECFDF5; font-size:0.85rem; font-weight:800; padding:0.25rem 0.65rem; border-radius:6px;">
                                ${window.escapeHTML(g.name)}
                            </span>
                        </td>
                        <td style="padding: 0.75rem 1rem; text-align:center; font-weight:700; color:#64756A;">
                            ${g.minMark}
                        </td>
                        <td style="padding: 0.75rem 1rem; text-align:center; font-weight:700; color:#64756A;">
                            ${g.maxMark}
                        ...
                        <td style="padding: 0.75rem 1rem; text-align:center;">
                            <span class="badge" style="background:#ECFDF5; color:#059669; border:1px solid #bbf7d0; font-size:0.85rem; font-weight:800; padding:0.2rem 0.6rem; border-radius:6px;">
                                ${g.gradePoint} pts
                            </span>
                        </td>
                        <td style="padding: 0.75rem 1rem; text-align:center;">
            ...
            modalBody.innerHTML = `
                ...
                <div style="padding: 1rem 1.5rem; max-height: 80vh; overflow-y: auto;">
                    ...
                    <div style="margin-bottom: 1.75rem;">
                        <h4 style="margin:0 0 0.4rem 0; font-size:0.95rem; font-weight:800; color:#17251B; display:flex; align-items:center; gap:0.4rem;">
                            🏅 Position / Rank Points Configuration
                        </h4>
                        <p style="margin: 0 0 0.85rem 0; font-size: 0.8rem; color: #64756A; line-height: 1.4;">
                            Configure points awarded for 1st, 2nd, and 3rd place across Individual, Group, and General program types.
                        </p>
                        
                        <div style="border: 1px solid #D8E8DE; border-radius: 8px; overflow: hidden; background:#ffffff;">
                            <table class="points-mgmt-table">
                                <thead>
                                    <tr style="background: #F5FAF7; border-bottom: 1px solid #D8E8DE;">
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A;">Point Rule</th>
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A; text-align:center;">Individual</th>
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A; text-align:center;">Group</th>
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A; text-align:center;">General</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="border-bottom: 1px solid #ECFDF5;">
                                        <td style="padding: 0.75rem 1rem; font-weight: 600; color: #64756A;">🥇 1st Place Points</td>
                                    ...
                                    <tr style="border-bottom: 1px solid #ECFDF5;">
                                        <td style="padding: 0.75rem 1rem; font-weight: 600; color: #64756A;">🥈 2nd Place Points</td>
                                        <td style="padding: 0.5rem 1rem; text-align:center;">
                                            <span class="points-mobile-label">Individual</span>
                                    ...
                                    <tr>
                                        <td style="padding: 0.75rem 1rem; font-weight: 600; color: #64756A;">🥉 3rd Place Points</td>
                                        <td style="padding: 0.5rem 1rem; text-align:center;">
                                            <span class="points-mobile-label">Individual</span>
                    ...
                    <div style="margin-bottom: 1.5rem;">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:0.6rem; flex-wrap:wrap; gap:0.5rem;">
                            <div>
                                <h4 style="margin:0; font-size:0.95rem; font-weight:800; color:#17251B; display:flex; align-items:center; gap:0.4rem;">
                                    🎓 Grade Management System
                                </h4>
                                <p style="margin: 0.2rem 0 0 0; font-size: 0.8rem; color: #64756A;">
                        ...
                        <div style="border: 1px solid #D8E8DE; border-radius: 8px; overflow: hidden; background:#ffffff;">
                            <table style="width:100%; border-collapse:collapse; text-align:left; font-size:13px;">
                                <thead>
                                    <tr style="background: #F5FAF7; border-bottom: 1px solid #D8E8DE;">
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A;">Grade</th>
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A; text-align:center;">Minimum Mark</th>
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A; text-align:center;">Maximum Mark</th>
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A; text-align:center;">Grade Point</th>
                                        <th style="padding: 0.75rem 1rem; font-weight: 700; color: #64756A; text-align:center; width:140px;">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ${renderGradeRowsHTML()}
                    ...
                    <div style="background: #F5FAF7; border: 1px solid #D8E8DE; border-radius: 8px; padding: 1rem; margin-bottom: 1.25rem; display: flex; align-items: flex-start; gap: 0.75rem;">
                        <input type="checkbox" id="chkRecalculatePoints" style="margin-top: 0.2rem; cursor: pointer;" checked />
                        <div>
                            <label for="chkRecalculatePoints" style="font-weight: 700; font-size: 13px; color: #17251B; cursor: pointer; display: block; margin-bottom: 0.25rem;">
                                🔄 Apply updated grade & point rules to all existing results?
                            </label>
                            <p style="margin: 0; font-size: 11px; color: #64756A; line-height: 1.4;">
                    ...
                    <!-- Bottom Buttons -->
                    <div style="display: flex; justify-content: flex-end; gap: 0.75rem; border-top: 1px solid #ECFDF5; padding-top: 1rem;">
                        <button class="btn btn-secondary" id="btnCancelPoints" style="padding: 0.5rem 1rem; font-size: 12px; font-weight: 700; color: #64756A; background: transparent; border: 1px solid #D8E8DE; border-radius: 6px; cursor: pointer;">Cancel</button>
                        <button class="btn btn-primary" id="btnSavePoints" style="padding: 0.5rem 1.25rem; font-size: 12px; font-weight: 700; color: #ffffff; background: #065F46; border: none; border-radius: 6px; cursor: pointer; display: inline-flex; align-items: center; gap: 0.5rem;">Save Rules</button>
                    </div>
                </div>
            `;
...
function openGradeFormModal(existingGrade, onSaveCallback) {
    ...
    overlay.style.cssText = "position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(23, 37, 27,0.6); z-index:9999; display:flex; align-items:center; justify-content:center; padding:1rem; backdrop-filter:blur(4px);";
    ...
    overlay.innerHTML = `
        <div style="background:#ffffff; border-radius:12px; width:100%; max-width:440px; box-shadow:0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04); overflow:hidden;">
            <div style="padding:1.25rem 1.5rem; border-bottom:1px solid #D8E8DE; display:flex; justify-content:space-between; align-items:center;">
                <h3 style="margin:0; font-size:1.1rem; font-weight:800; color:#17251B;">
                    ${isEdit ? '✏️ Edit Grade' : '➕ Add Grade'}
                </h3>
                <button type="button" id="btnCloseGradeForm" style="background:none; border:none; font-size:1.25rem; color:#64756A; cursor:pointer;">✕</button>
            </div>
            ...
            <div style="padding:1.25rem 1.5rem;">
                ...
                <div style="margin-bottom:1rem;">
                    <label style="display:block; font-size:0.8rem; font-weight:700; color:#64756A; margin-bottom:0.35rem;">Grade Name *</label>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.75rem; margin-bottom:1rem;">
                    <div>
                        <label style="display:block; font-size:0.8rem; font-weight:700; color:#64756A; margin-bottom:0.35rem;">Minimum Mark *</label>
                    ...
                    <div>
                        <label style="display:block; font-size:0.8rem; font-weight:700; color:#64756A; margin-bottom:0.35rem;">Maximum Mark *</label>
                ...
                <div style="margin-bottom:1.25rem;">
                    <label style="display:block; font-size:0.8rem; font-weight:700; color:#64756A; margin-bottom:0.35rem;">Grade Point *</label>
                ...
                <div style="display:flex; justify-content:flex-end; gap:0.75rem; border-top:1px solid #ECFDF5; padding-top:1rem;">
                    <button type="button" id="btnCancelGradeForm" class="btn btn-secondary" style="padding:0.45rem 1rem; font-size:0.8rem; font-weight:700; color:#64756A; background:transparent; border:1px solid #D8E8DE; border-radius:6px; cursor:pointer;">Cancel</button>
                    <button type="button" id="btnSaveGradeForm" class="btn btn-primary" style="padding:0.45rem 1.25rem; font-size:0.8rem; font-weight:700; color:#ffffff; background:#065F46; border:none; border-radius:6px; cursor:pointer;">Save Grade</button>
                </div>
            </div>
        </div>
    `;
...
function openLimitsManageModal() {
    ...
    modalBody.innerHTML = `
        <div style="padding: 1rem 1.5rem; max-height: 80vh; overflow-y: auto;">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid #D8E8DE; padding-bottom:0.75rem; margin-bottom:1rem; flex-wrap:wrap; gap:0.5rem;">
                <label style="display:inline-flex; align-items:center; gap:0.5rem; cursor:pointer; font-weight:700; color:#17251B; font-size:0.85rem; user-select:none;">
            ...
            <p style="font-size:0.75rem; color:#64756A; margin-top:-0.5rem; margin-bottom:1.25rem;">
                ...
                <span style="display:block; margin-top:0.35rem; color:var(--pw-primary, #059669); font-weight:600;">
            ...
            <div id="limitsConfigSection" style="${isEnabled ? 'display:block;' : 'display:none;'}">
                <div class="limits-responsive-grid" style="display:grid; grid-template-columns: 1fr 1.2fr; gap:1.5rem; align-items:start; width:100%;">
                    ...
                    <div style="background:#F5FAF7; border:1px solid #D8E8DE; border-radius:12px; padding:1.25rem; box-shadow:inset 0 1px 2px rgba(0,0,0,0.025);">
                        <h4 style="margin:0 0 1rem 0; font-size:0.8rem; font-weight:700; color:#64756A; letter-spacing:0.5px; text-transform:uppercase; border-bottom:1px solid #D8E8DE; padding-bottom:0.5rem;">
                            DEFAULT LIMITS FOR EVERYONE
                        </h4>
                        <form id="frmDefaultLimits" style="display:flex; flex-direction:column; gap:0.85rem;">
                            <div class="form-group-compact">
                                <label class="form-label-compact" style="font-weight:600; color:#64756A; font-size:0.78rem;">Individual Stage Programs Limit</label>
                            ...
                            <div class="form-group-compact">
                                <label class="form-label-compact" style="font-weight:600; color:#64756A; font-size:0.78rem;">Individual Off Stage Programs Limit</label>
                            ...
                            <div class="form-group-compact">
                                <label class="form-label-compact" style="font-weight:600; color:#64756A; font-size:0.78rem;">General Programs Limit</label>
                            ...
                            <div class="form-group-compact">
                                <label class="form-label-compact" style="font-weight:600; color:#64756A; font-size:0.78rem;">Group Programs Limit</label>
                            ...
                            <p style="font-size:0.7rem; color:#64756A; margin:0 0 0.25rem 0; line-height:1.3;">
                    ...
                    <div>
                        <h4 style="margin:0 0 1rem 0; font-size:0.8rem; font-weight:700; color:#64756A; letter-spacing:0.5px; text-transform:uppercase;">
                            SPECIFIC RULES
                        </h4>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 0.75rem; border-top: 1px solid #ECFDF5; padding-top: 1rem; margin-top: 1.5rem;">
                <button class="btn btn-secondary" id="btnCancelLimits" style="padding: 0.5rem 1.25rem; font-size: 12px; font-weight: 700; color: #64756A; background: transparent; border: 1px solid #D8E8DE; border-radius: 6px; cursor: pointer;">Close</button>
            </div>
        </div>
    `;
    modal.classList.remove('hidden');
    ...
    modalBody.innerHTML = `
        <div style="padding: 1rem 1.5rem; max-height: 80vh; overflow-y: auto;">
            ...
            <div class="reset-options-list" style="display:flex; flex-direction:column; gap:1.25rem;">
                <div class="reset-option-item" style="display:flex; justify-content:space-between; align-items:center; gap:1rem; border-bottom:1px solid #ECFDF5; padding-bottom:0.75rem;">
                    <div class="reset-details" style="flex:1;">
                        <h4 style="margin:0 0 0.25rem 0; font-size:0.85rem; font-weight:700; color:#17251B;">Reset Results Only</h4>
                        <p style="margin:0; font-size:0.75rem; color:#64756A; line-height:1.4;">Deletes all Marks, Standings, and Rankings. Keeps Students, Teams, Categories, and Programs intact.</p>
                    </div>
                ...
                <div class="reset-option-item" style="display:flex; justify-content:space-between; align-items:center; gap:1rem; border-bottom:1px solid #ECFDF5; padding-bottom:0.75rem;">
                    <div class="reset-details" style="flex:1;">
                        <h4 style="margin:0 0 0.25rem 0; font-size:0.85rem; font-weight:700; color:#17251B;">Reset Registrations</h4>
                        <p style="margin:0; font-size:0.75rem; color:#64756A; line-height:1.4;">Deletes Participant registrations & Program assignments. Keeps Students, Teams, Categories, and Programs.</p>
                    </div>
                ...
                <div class="reset-option-item" style="display:flex; justify-content:space-between; align-items:center; gap:1rem; border-bottom:1px solid #ECFDF5; padding-bottom:0.75rem;">
                    <div class="reset-details" style="flex:1;">
                        <h4 style="margin:0 0 0.25rem 0; font-size:0.85rem; font-weight:700; color:#17251B;">Reset Event Data</h4>
                        <p style="margin:0; font-size:0.75rem; color:#64756A; line-height:1.4;">Deletes Marks, Results, and Registrations. Keeps Students, Teams, Categories, and Programs.</p>
                    </div>
                ...
                <div class="reset-option-item" style="display:flex; justify-content:space-between; align-items:center; gap:1rem; border-bottom:1px solid #ECFDF5; padding-bottom:0.75rem;">
                    <div class="reset-details" style="flex:1;">
                        <h4 style="margin:0 0 0.25rem 0; font-size:0.85rem; font-weight:700; color:#17251B;">Factory Reset Institute</h4>
                        <p style="margin:0; font-size:0.75rem; color:#64756A; line-height:1.4;">Full purge. Deletes all Students, Teams, Categories, Programs, Results, and Registrations. Returns to clean state.</p>
                    </div>
                ...
                <div class="reset-option-item" style="display:flex; justify-content:space-between; align-items:center; gap:1rem; padding-bottom:0.75rem;">
                    <div class="reset-details" style="flex:1;">
                        <h4 style="margin:0 0 0.25rem 0; font-size:0.85rem; font-weight:700; color:#17251B;">Clear Local Cache & Storage</h4>
                        <p style="margin:0; font-size:0.75rem; color:#64756A; line-height:1.4;">Clears browser local storage, session storage, and invalidates all local caches. Forces a fresh application reload.</p>
                    </div>
                    <button class="btn btn-danger btn-sm" id="btnClearLocalCache" style="flex-shrink:0; background: #D8E8DE; border-color: #D8E8DE; color: #64756A;">Clear Cache</button>
                </div>
            </div>

            <div style="display: flex; justify-content: flex-end; gap: 0.75rem; border-top: 1px solid #ECFDF5; padding-top: 1rem; margin-top: 1rem;">
                <button class="btn btn-secondary" id="btnCancelDangerZone" style="padding: 0.5rem 1.25rem; font-size: 12px; font-weight: 700; color: #64756A; background: transparent; border: 1px solid #D8E8DE; border-radius: 6px; cursor: pointer;">Close</button>
            </div>
        </div>
    `;
    modal.classList.remove('hidden');
...
function renderSpecificRulesList() {
    ...
    if (rules.length === 0) {
        container.innerHTML = `
            <div style="text-align:center; padding:2rem 1rem; color:#64756A; border:1.5px dashed #D8E8DE; border-radius:12px;">
                <span style="font-size:1.75rem; display:block; margin-bottom:0.25rem;">📝</span>
                <span style="font-size:0.78rem; font-weight:600; color:#64756A;">No specific rules added</span>
                <p style="font-size:0.72rem; margin:0.15rem 0 0 0; color:#64756A;">Click "+ Add Specific Rule" to set limit overrides for categories or genders.</p>
            </div>
        `;
        return;
    }
        ...
        return `
            <div class="specific-rule-row" style="background:#ffffff; border:1px solid #D8E8DE; border-radius:10px; padding:0.75rem 1rem; display:flex; justify-content:space-between; align-items:center; gap:0.5rem; transition:transform 0.2s, box-shadow 0.2s; box-shadow:0 1px 2px rgba(0,0,0,0.02); hover:transform:translateY(-1px); hover:box-shadow:0 3px 6px rgba(0,0,0,0.05);">
                ...
                <div style="display:flex; gap:0.35rem;">
                    ...
                    <button class="btn btn-danger btn-sm btn-delete-rule" data-index="${idx}" style="font-size:0.72rem; padding:0.25rem 0.5rem; min-height:28px; background:#fef2f2; border-color:#fee2e2; color:#EF4444;">Delete</button>
                </div>
            </div>
        `;
    }).join('');
...
function openSpecificRuleModal(ruleIndex = null) {
    ...
    modalBody.innerHTML = `
        <form id="frmSpecificRule" autocomplete="off" style="display:flex; flex-direction:column; gap:1rem;">
            <div style="background:#F5FAF7; border:1px solid #D8E8DE; border-radius:10px; padding:0.75rem; margin-bottom:0.25rem;">
                <h4 style="margin:0 0 0.5rem 0; font-size:0.75rem; font-weight:700; color:#64756A; letter-spacing:0.5px; text-transform:uppercase;">
                    APPLY THIS RULE TO
                </h4>
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.75rem;">
                    <div class="form-group-compact">
                        <label class="form-label-compact" style="font-weight:600; color:#64756A;">Category</label>
                    ...
                    <div class="form-group-compact">
                        <label class="form-label-compact" style="font-weight:600; color:#64756A;">Gender</label>
            ...
            <div style="background:#F5FAF7; border:1px solid #D8E8DE; border-radius:10px; padding:0.75rem;">
                <h4 style="margin:0 0 0.75rem 0; font-size:0.75rem; font-weight:700; color:#64756A; letter-spacing:0.5px; text-transform:uppercase; border-bottom:1px solid #D8E8DE; padding-bottom:0.25rem;">
                    LIMITS FOR MATCHING STUDENTS
                </h4>
                <p style="font-size:0.7rem; color:#64756A; margin:-0.25rem 0 0.75rem 0;">
                ...
                <div style="display:flex; flex-direction:column; gap:0.75rem;">
                    ...
                    <div class="form-group-compact" style="display:grid; grid-template-columns: 1fr 1fr; gap:0.75rem; align-items:center;">
                        <label class="form-label-compact" style="font-weight:600; color:#64756A; margin:0;">Individual Stage</label>
                    ...
                    <div class="form-group-compact" style="display:grid; grid-template-columns: 1fr 1fr; gap:0.75rem; align-items:center;">
                        <label class="form-label-compact" style="font-weight:600; color:#64756A; margin:0;">Individual Off Stage</label>
                        <div style="display:flex; flex-direction:column; gap:0.35rem;">
                    ...
                    <!-- General Programs -->
                    <div class="form-group-compact" style="display:grid; grid-template-columns: 1fr 1fr; gap:0.75rem; align-items:center;">
                        <label class="form-label-compact" style="font-weight:600; color:#64756A; margin:0;">General Programs</label>
                        <div style="display:flex; flex-direction:column; gap:0.35rem;">
                    ...
                    <!-- Group Programs -->
                    <div class="form-group-compact" style="display:grid; grid-template-columns: 1fr 1fr; gap:0.75rem; align-items:center;">
                        <label class="form-label-compact" style="font-weight:600; color:#64756A; margin:0;">Group Programs</label>
                        <div style="display:flex; flex-direction:column; gap:0.35rem;">
...
function renderRecoveryBinList() {
    ...
    if (recoveryBinItems.length === 0) {
        container.innerHTML = `
            <div style="text-align:center; padding:2rem 1rem; color:#64756A;">
                <span style="font-size:2.5rem; display:block; margin-bottom:0.5rem; opacity:0.5;">🗑</span>
                <h4 style="font-weight:700; color:#64756A; margin:0 0 0.25rem 0;">Trash is empty</h4>
    ...
    container.innerHTML = `
        <div style="overflow-x:auto;">
            <table style="width:100%; border-collapse:collapse; min-width:600px; font-size:0.85rem; color:#17251B;">
                <thead>
                    <tr style="background:#F5FAF7; border-bottom:2px solid #D8E8DE; text-align:left;">
                        <th style="padding:0.5rem; color:#64756A; font-weight:700; width:120px;">Type</th>
                        <th style="padding:0.5rem; color:#64756A; font-weight:700;">Name/Details</th>
                        <th style="padding:0.5rem; color:#64756A; font-weight:700; width:150px;">Deleted At</th>
                        <th style="padding:0.5rem; color:#64756A; font-weight:700; width:150px;">Time Remaining</th>
                        <th style="padding:0.5rem; color:#64756A; font-weight:700; width:150px; text-align:center;">Actions</th>
                    </tr>
                </thead>
                <tbody>
                    ${sorted.map(item => {
        ...
        let badgeColor = '#64756A';
        if (item.type === 'student') badgeColor = '#059669';
        else if (item.type === 'team') badgeColor = '#059669';
        else if (item.type === 'program') badgeColor = '#F59E0B';
        else if (item.type === 'result') badgeColor = '#c2410c';

        return `
                            <tr style="border-bottom:1px solid #ECFDF5; hover:background:#F5FAF7;">
                                ...
                                <td style="padding:0.5rem; font-weight:600; color:#64756A;">${window.escapeHTML(detailName)}</td>
                                <td style="padding:0.5rem; color:#64756A;">${new Date(item.deletedAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })} (${new Date(item.deletedAt).toLocaleDateString()})</td>
...
function bindFormEvents() {
    ...
    if (removeBtn) {
        removeBtn.onclick = () => {
            ...
            if (previewContainer) {
                previewContainer.innerHTML = `<span id="eventLogoPlaceholder" style="font-size:0.7rem; color:#64756A; text-align:center; padding:2px;">No Logo</span>`;
            }
    ...
    if (resetBtn) {
        resetBtn.onclick = async () => {
            ...
            if (previewContainer) {
                previewContainer.innerHTML = localConfig.eventLogo ? `<img id="eventLogoPreviewImg" src="${localConfig.eventLogo}" style="max-width:100%; max-height:100%; object-fit:contain;" />` : `<span id="eventLogoPlaceholder" style="font-size:0.7rem; color:#64756A; text-align:center; padding:2px;">No Logo</span>`;
            }
            ...
            <div class="modal-body warning-modal-body" style="display:flex; flex-direction:column; gap:1.25rem; padding:1.5rem;">
                ...
                <div class="backup-recommended-box">
                    ...
                    <div style="flex:1;">
                        ...
                        <p style="margin:0.15rem 0 0 0; font-size:0.75rem; color:#F59E0B;">Export and download active event collections to a JSON file.</p>
                    </div>
                ...
                <div style="border-top:1px dashed #D8E8DE; padding-top:1rem; display:flex; flex-direction:column; gap:0.75rem;">
                    <!-- Continue Trigger -->
