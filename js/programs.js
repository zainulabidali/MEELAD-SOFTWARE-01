...
function renderProgramsUI() {
    ...
    localPrograms.forEach((prog, idx) => {
        ...
        row.innerHTML = `
            <div class="program-sl-cell" style="font-weight:700; color:#64756A; font-size:0.85rem;">
                ${idx + 1}
            </div>
    ...
    if (progId) {
        ...
        modalBody.innerHTML = `
            <form id="programForm" autocomplete="off">
                ...
                <div class="form-group" id="groupSizeRow" style="display:${isGroup ? 'block' : 'none'};">
                    <label class="form-label">Group Size * <span style="font-size:0.75rem;color:#64756A;">(max participants per team)</span></label>
        ...
        modalBody.innerHTML = `
            <div class="bulk-prog-container">
                <!-- Filter Section -->
                <div class="bulk-filter-bar" style="display:grid; grid-template-columns: repeat(auto-fit, minmax(130px, 1fr)); gap:0.5rem; margin-bottom:1rem; padding:0.75rem; background:#F5FAF7; border:1.5px solid #D8E8DE; border-radius:10px; transition: opacity 0.2s ease;">
                    <div class="form-group-compact" style="display:flex; flex-direction:column; gap:0.15rem;">
                        <label class="form-label-compact" style="font-size:0.68rem; font-weight:700; color:#64756A; text-transform:uppercase;">Category</label>
                        <select id="bulkCat" class="form-input-compact select-premium" style="font-size:0.78rem; padding:0.35rem 0.5rem; border-radius:6px; border:1px solid #D8E8DE;">
                            ${categoryOptionsHTML}
                        </select>
                    </div>
                    <div class="form-group-compact" style="display:flex; flex-direction:column; gap:0.15rem;">
                        <label class="form-label-compact" style="font-size:0.68rem; font-weight:700; color:#64756A; text-transform:uppercase;">Type Scope</label>
                        <select id="bulkTypeScope" class="form-input-compact select-premium" style="font-size:0.78rem; padding:0.35rem 0.5rem; border-radius:6px; border:1px solid #D8E8DE;">
                            <option value="competition" selected>Competition Program</option>
                        </select>
                    </div>
                    <div class="form-group-compact" style="display:flex; flex-direction:column; gap:0.15rem;">
                        <label class="form-label-compact" style="font-size:0.68rem; font-weight:700; color:#64756A; text-transform:uppercase;">Gender</label>
                        <select id="bulkGender" class="form-input-compact select-premium" style="font-size:0.78rem; padding:0.35rem 0.5rem; border-radius:6px; border:1px solid #D8E8DE;">
                ...
                <div class="bulk-table-container" style="max-height: 40vh; overflow-y: auto; border: 1.5px solid #D8E8DE; border-radius: 10px; margin-bottom: 1rem; background: #ffffff;">
                    <table class="bulk-table" style="width:100%; border-collapse:collapse; font-size:0.8rem; text-align:left;">
                        <thead style="background:#F5FAF7; position:sticky; top:0; z-index:10; border-bottom:1.5px solid #D8E8DE;">
                            <tr>
                                <th style="padding:0.6rem 0.75rem; width:40px; border-bottom:1.5px solid #D8E8DE;"><input type="checkbox" id="bulkSelectAll" checked style="cursor:pointer;" /></th>
                                <th style="padding:0.6rem 0.75rem; border-bottom:1.5px solid #D8E8DE;">Program Name *</th>
                                <th style="padding:0.6rem 0.75rem; width:140px; border-bottom:1.5px solid #D8E8DE;">Location *</th>
                                <th style="padding:0.6rem 0.75rem; width:130px; border-bottom:1.5px solid #D8E8DE;">Type *</th>
                                <th style="padding:0.6rem 0.75rem; width:100px; border-bottom:1.5px solid #D8E8DE;">Group Size</th>
                                <th style="padding:0.6rem 0.75rem; width:70px; border-bottom:1.5px solid #D8E8DE; text-align:center;">Action</th>
                            </tr>
                        </thead>
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:0.5rem; margin-bottom:1rem;">
                    ...
                    <div style="font-size:0.75rem; color:#64756A; font-weight:600;" id="bulkSelectionStats">0 / 0 Selected</div>
                </div>

                <div class="modal-actions" style="border-top:1.5px solid #D8E8DE; padding-top:0.75rem; margin-top:0.5rem; display:flex; justify-content:flex-end; gap:0.5rem;">
        ...
        const renderEmptyState = () => {
            ...
            tbody.innerHTML = `
                <tr id="bulkEmptyState">
                    <td colspan="6" style="text-align:center; padding:2.5rem 0; color:#64756A; font-style:italic;">
        ...
        document.getElementById('bulkAddCustomRow').onclick = () => {
            ...
            tr.innerHTML = `
                <td style="padding:0.45rem 0.75rem; border-bottom:1px solid #D8E8DE; vertical-align: middle;"><input type="checkbox" class="bulk-row-check" checked style="cursor:pointer;" /></td>
                <td style="padding:0.45rem 0.75rem; border-bottom:1px solid #D8E8DE; vertical-align: middle;"><input type="text" class="bulk-row-name form-input" placeholder="Program Name *" style="font-size:0.75rem; width:100%; border:1px solid #D8E8DE; border-radius:4px; padding:0.25rem 0.4rem; height:auto; min-height:initial;" /></td>
                <td style="padding:0.45rem 0.75rem; border-bottom:1px solid #D8E8DE; vertical-align: middle;">
                    <select class="bulk-row-loc form-input" style="font-size:0.75rem; width:100%; border:1px solid #D8E8DE; border-radius:4px; padding:0.2rem 0.4rem; height:auto; min-height:initial;">
                        <option value="Stage" selected>Stage</option>
                        <option value="Off Stage">Off Stage</option>
                    </select>
                </td>
                <td style="padding:0.45rem 0.75rem; border-bottom:1px solid #D8E8DE; vertical-align: middle;">
                    <select class="bulk-row-type form-input" style="font-size:0.75rem; width:100%; border:1px solid #D8E8DE; border-radius:4px; padding:0.2rem 0.4rem; height:auto; min-height:initial;">
                        <option value="individual" selected>Individual</option>
                        <option value="group">Group</option>
                    </select>
                </td>
                <td style="padding:0.45rem 0.75rem; border-bottom:1px solid #D8E8DE; vertical-align: middle;"><input type="number" class="bulk-row-size form-input" min="2" placeholder="Size" style="font-size:0.75rem; width:100%; border:1px solid #D8E8DE; border-radius:4px; padding:0.25rem 0.4rem; display:none; height:auto; min-height:initial;" /></td>
                <td style="padding:0.45rem 0.75rem; border-bottom:1px solid #D8E8DE; text-align:center; vertical-align: middle;">
    ...
    modalBody.innerHTML = `
        <form id="generalProgramForm" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="General" readonly disabled style="background:#ECFDF5; cursor:not-allowed;">
            </div>
            <div class="form-group">
                <label class="form-label">Program Location *</label>
                <select id="pLocation" class="form-input" required>
...
function openProgramsDropdown(btn) {
    ...
    dropdown.innerHTML = `
        <button class="dropdown-item btn-view-parts" style="display:flex; align-items:center; gap:0.5rem; width:100%; border:none; background:transparent; padding:0.5rem 0.85rem; font-size:12px; font-weight:600; color:#64756A; text-align:left; cursor:pointer;">
            👥 Add Students
        </button>
        <button class="dropdown-item btn-edit-prog" style="display:flex; align-items:center; gap:0.5rem; width:100%; border:none; background:transparent; padding:0.5rem 0.85rem; font-size:12px; font-weight:600; color:#64756A; text-align:left; cursor:pointer;">
            ✏️ Edit Program
        </button>
        <button class="dropdown-item btn-delete-prog text-danger" style="display:flex; align-items:center; gap:0.5rem; width:100%; border:none; background:transparent; padding:0.5rem 0.85rem; font-size:12px; font-weight:600; color:#EF4444; text-align:left; cursor:pointer;">
            🗑️ Delete Program
        </button>
    `;
