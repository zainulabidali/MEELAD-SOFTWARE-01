        ...
        overviewContainer.innerHTML = `
            <div class="program-assignment-overview">
                ...
                <div class="overview-loading-skeleton">
                    <span class="spinner-small" style="display:inline-block; width:16px; height:16px; border:2px solid #D8E8DE; border-top:2px solid #3b82f6; border-radius:50%; animation:spin 1s linear infinite; vertical-align:middle; margin-right:8px;"></span>
...
function openTeamDropdown(btn) {
    ...
    dropdown.innerHTML = `
        <button class="dropdown-item btn-edit-team" style="display:flex; align-items:center; gap:0.5rem; width:100%; border:none; background:transparent; padding:0.5rem 0.85rem; font-size:12px; font-weight:600; color:#64756A; text-align:left; cursor:pointer;">
            ✏️ Edit
        </button>
        <button class="dropdown-item btn-leader-access" style="display:flex; align-items:center; gap:0.5rem; width:100%; border:none; background:transparent; padding:0.5rem 0.85rem; font-size:12px; font-weight:600; color:#64756A; text-align:left; cursor:pointer;">
            🔑 Leader Access
        </button>
        <button class="dropdown-item btn-delete-team text-danger" style="display:flex; align-items:center; gap:0.5rem; width:100%; border:none; background:transparent; padding:0.5rem 0.85rem; font-size:12px; font-weight:600; color:#EF4444; text-align:left; cursor:pointer;">
            🗑️ Delete
        </button>
    `;
...
function openLeaderAccessModal(teamId, teamName) {
    ...
    modalBody.innerHTML = `
        <div style="font-family:'Inter', sans-serif;">
            <div style="background:#F5FAF7; border:1px solid #D8E8DE; border-radius:8px; padding:1rem; margin-bottom:1.5rem;">
                <h4 style="margin:0 0 0.5rem 0; font-size:1rem; color:#17251B;">${window.escapeHTML(teamName)}</h4>
                <div style="font-size:0.8rem; color:#64756A; display:grid; grid-template-columns:1fr 1fr; gap:0.5rem;">
            ...
            <div style="margin-bottom:1.5rem;">
                <label class="form-label" style="display:flex; justify-content:space-between; align-items:center; font-weight:600; font-size:0.85rem; color:#64756A;">
                ...
                <div style="display:flex; align-items:center; gap:0.75rem; margin-top:0.5rem;">
                    ...
                    <span style="font-size:0.85rem; font-weight:600; color:#64756A;" id="toggleLabelText">
            ...
            <div id="leaderLinkSection" class="${isAccessEnabled ? '' : 'hidden'}" style="margin-bottom:1.5rem;">
                <div class="form-group">
                    <label class="form-label" style="font-weight:600; font-size:0.85rem; color:#64756A;">Leader Portal Access Link</label>
                    <div style="display:flex; gap:0.5rem; margin-top:0.5rem;">
                        <input type="text" id="leaderPortalUrl" class="form-input" readonly value="${token ? portalUrl : 'Not Generated Yet'}" style="font-family:monospace; font-size:0.75rem; flex:1; background:#ECFDF5; cursor:text;">
                ...
                <div style="display:flex; gap:0.5rem; margin-top:0.75rem;">
                    ...
                    <button class="btn btn-secondary w-full text-danger" id="btnRegenerateLeaderToken" style="font-size:0.8rem; font-weight:600; color:#EF4444; border-color:rgba(220,38,38,0.2);" ${token ? '' : 'disabled'}>🔄 Regenerate Link</button>
                </div>
            </div>

            <div class="pw-summary-panel" style="background:#ECFDF5; border:1px solid #bbf7d0; border-radius:8px; padding:1rem; margin-bottom:1.5rem; margin-top:1rem;">
                <h5 style="margin:0 0 0.5rem 0; font-size:0.8rem; text-transform:uppercase; color:#047857; letter-spacing:0.5px;">📋 Permission Summary</h5>
                <ul style="margin:0; padding-left:1.2rem; font-size:0.75rem; color:#065F46; line-height:1.4;">
