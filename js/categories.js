...
function renderCategoriesUI() {
    ...
    localCategories.forEach((cat) => {
        ...
        const classesHTML = classes.length > 0
            ...
            : '<span style="color:#64756A; font-size:0.85rem; font-style:italic;">No classes</span>';
        ...
        tableHTML += `
            <div class="category-row">
                ...
                <div class="category-chest-range-cell" style="font-weight: 700; color: #64756A; font-size: 0.8rem;">
...
function openCategoryModal(catId = null, currentName = '', currentDesc = '', currentClasses = [], currentChestStart = '', currentChestEnd = '') {
    ...
    const buildChipsHTML = (classes) => classes.map((c) =>
        `<span class="class-chip" data-id="${c.id}" style="display:inline-flex; align-items:center; gap:0.3rem; background:#ECFDF5; color:#64756A; border:1px solid #D8E8DE; border-radius:999px; padding:0.25rem 0.65rem; font-size:0.75rem; font-weight:700; margin:0.2rem;">
    ...
    modalBody.innerHTML = `
        <form id="categoryForm">
            ...
            <div class="form-group">
                ...
                <p style="font-size:0.72rem; color:#64756A; margin-top:0.4rem;">Enter each class name and add it to the category. Duplicate names are not allowed.</p>
            </div>
...
function openCategoryDropdown(btn) {
    ...
    dropdown.innerHTML = `
        <button class="dropdown-item btn-edit-cat" style="display:flex; align-items:center; gap:0.5rem; width:100%; border:none; background:transparent; padding:0.5rem 0.85rem; font-size:12px; font-weight:600; color:#64756A; text-align:left; cursor:pointer;">
            ✏️ Edit
        </button>
        <button class="dropdown-item btn-delete-cat text-danger" style="display:flex; align-items:center; gap:0.5rem; width:100%; border:none; background:transparent; padding:0.5rem 0.85rem; font-size:12px; font-weight:600; color:#EF4444; text-align:left; cursor:pointer;">
            🗑️ Delete
        </button>
    `;
