...
const firebaseConfig = {
  apiKey: "AIzaSyBDdWnwHE8ZqaGASh1JRixE5B_H_v8pMoE",
  authDomain: "meelad-software-01.firebaseapp.com",
  projectId: "meelad-software-01",
  storageBucket: "meelad-software-01.firebasestorage.app",
  messagingSenderId: "374698244260",
  appId: "1:374698244260:web:3fd07b61bbab488c2e0e31",
  measurementId: "G-12W6VMS6XV"
};
...
window.customConfirm = function (message, title = "Confirm Action", options = {}) {
    ...
    const iconBg = options.iconBg || (danger ? "rgba(220, 38, 38, 0.08)" : "rgba(79, 70, 229, 0.08)");
    const iconColor = options.iconColor || (danger ? "#EF4444" : "#065F46");
...
window.customAlert = function (message, title = "Alert", options = {}) {
    ...
    const iconColor = options.iconColor || "#065F46";
