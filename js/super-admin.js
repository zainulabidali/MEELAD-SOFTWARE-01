        ...
        tableBody.innerHTML = `
            <tr>
                <td colspan="6" style="text-align: center; padding: 3rem 1rem;">
                    ...
                    <h4 style="margin: 0; font-size: 1.1rem; color: #64756A; font-weight: 700;">No matching institutes found</h4>
                    <p style="margin: 0.25rem 0 0 0; font-size: 0.875rem; color: #64756A;">Try adjusting your search terms or filters.</p>
                </td>
            </tr>
        `;
    } else {
            ...
            tr.innerHTML = `
                <td>
                    <div>
                        ...
                        <div style="font-size: 0.75rem; color: #64756A; font-weight: 600; margin-top: 2px;">
                            Code: <code style="background: #ECFDF5; padding: 2px 4px; border-radius: 4px; font-family: monospace;">${escapeHTML(inst.id)}</code>
                        </div>
                    </div>
                </td>
                <td>
                    <span style="font-weight: 600; color: #64756A;">📍 ${escapeHTML(inst.teacherPlace)}</span>
                </td>
                <td>
                    <span style="font-weight: 600; color: #64756A;">✉️ <a href="mailto:${escapeHTML(inst.teacherEmail)}" style="color: #059669;">${escapeHTML(inst.teacherEmail)}</a></span>
                </td>
                <td>
                    <span style="font-weight: 600; color: #64756A;">📅 ${createdStr}</span>
                </td>
                <td>
                    <span style="font-weight: 600; color: #064E3B;">📅 ${expiryStr}</span>
                </td>
                <td>
...
async function openViewInstituteModal(instId) {
    ...
    viewBody.innerHTML = `
        <div class="view-details-container" style="display: flex; flex-direction: column; gap: 1.5rem;">
            ...
            <!-- Header banner -->
            <div class="details-header-card" style="display: flex; align-items: center; justify-content: space-between; gap: 1.25rem; padding: 1.25rem; background: linear-gradient(135deg, #F5FAF7, #ECFDF5); border-radius: 16px; border: 1px solid #D8E8DE; margin-bottom: 0;">
                <div style="display: flex; align-items: center; gap: 1.25rem;">
                    <div class="details-avatar" style="width: 56px; height: 56px; border-radius: 16px; background: linear-gradient(135deg, #059669, #065F46); color: #ffffff; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; font-weight: 800; flex-shrink: 0; box-shadow: 0 8px 20px rgba(4, 120, 87, 0.25);">${escapeHTML(initial)}</div>
                    <div>
                        <span class="inst-type-badge" style="font-size: 0.68rem; font-weight: 800; padding: 0.15rem 0.45rem; border-radius: 6px; background: #e0e7ff; color: #064E3B; text-transform: uppercase; letter-spacing: 0.04em;">${escapeHTML(inst.type)}</span>
                        <h2 style="font-size: 1.35rem; font-weight: 800; margin: 4px 0 0 0; color: #17251B; font-family: 'Outfit', sans-serif;">${escapeHTML(inst.name)}</h2>
                    </div>
                </div>
                <div>
            ...
            <div class="details-grid-layout" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 1.25rem;">
                ...
                <div class="details-section-card" style="background: #ffffff; border: 1px solid #D8E8DE; border-radius: 16px; padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem;">
                    <h3 style="margin: 0; font-size: 1rem; font-weight: 800; color: #17251B; display: flex; align-items: center; gap: 8px; border-bottom: 1px solid #ECFDF5; padding-bottom: 0.5rem; font-family: 'Outfit', sans-serif;">
                        <span>🏫</span> Institute Information
                    </h3>
                    <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                        <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #ECFDF5; padding-bottom: 0.5rem; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Name</span>
                            <span style="font-size: 0.875rem; color: #17251B; font-weight: 700; text-align: right;">${escapeHTML(inst.name)}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #ECFDF5; padding-bottom: 0.5rem; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Institute Code</span>
                            <code style="font-size: 0.8rem; color: #064E3B; font-weight: 700; background: #f5f3ff; padding: 2px 6px; border-radius: 4px; font-family: monospace;">${escapeHTML(inst.id)}</code>
                        </div>
                        <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #ECFDF5; padding-bottom: 0.5rem; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Address / Location</span>
                            <span style="font-size: 0.875rem; color: #17251B; font-weight: 700; text-align: right;">${escapeHTML(inst.teacherPlace)}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Type</span>
                            <span style="font-size: 0.875rem; color: #64756A; font-weight: 700;">${escapeHTML(inst.type)}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="details-section-card" style="background: #ffffff; border: 1px solid #D8E8DE; border-radius: 16px; padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                        <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #ECFDF5; padding-bottom: 0.5rem; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Admin Name</span>
                            <span style="font-size: 0.875rem; color: #17251B; font-weight: 700; text-align: right;">${escapeHTML(inst.teacherName)}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #ECFDF5; padding-bottom: 0.5rem; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Email</span>
                            <span style="font-size: 0.875rem; color: #17251B; font-weight: 700; text-align: right;"><a href="mailto:${escapeHTML(inst.teacherEmail)}" style="color: #059669;">${escapeHTML(inst.teacherEmail)}</a></span>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Phone Number</span>
                            <span style="font-size: 0.875rem; color: #17251B; font-weight: 700; text-align: right;">${escapeHTML(inst.teacherPhone)}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="details-section-card" style="background: #ffffff; border: 1px solid #D8E8DE; border-radius: 16px; padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                        <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #ECFDF5; padding-bottom: 0.5rem; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Registration Date</span>
                            <span style="font-size: 0.875rem; color: #17251B; font-weight: 700;">${createdStr}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #ECFDF5; padding-bottom: 0.5rem; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Expiry Date</span>
                            <span style="font-size: 0.875rem; color: #e11d48; font-weight: 700;">${expiryStr}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #ECFDF5; padding-bottom: 0.5rem; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Status</span>
                            <span class="badge ${badgeClass}" style="font-size: 0.7rem; font-weight: 800; padding: 2px 8px; border-radius: 4px;">${statusLabel}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <span style="font-size: 0.75rem; color: #64756A; font-weight: 700; text-transform: uppercase;">Plan Type</span>
                            <span style="font-size: 0.875rem; color: #065F46; font-weight: 700;">${inst.expiryDate ? 'Annual Plan' : 'Trial Plan'}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="details-section-card" style="background: #ffffff; border: 1px solid #D8E8DE; border-radius: 16px; padding: 1.25rem; display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <div id="modalStatsGrid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.75rem; text-align: center; height: 100%; align-content: center;">
                        <div style="background: #F5FAF7; padding: 0.6rem; border-radius: 10px; border: 1px solid #ECFDF5; display: flex; flex-direction: column; justify-content: center; min-height: 52px;">
                            <div style="font-size: 1.15rem; font-weight: 800; color: #065F46; line-height: 1.1;" id="statStudents">⏳</div>
                            <div style="font-size: 0.55rem; color: #64756A; font-weight: 700; text-transform: uppercase; margin-top: 4px; letter-spacing: 0.02em;">Students</div>
                        </div>
                        <div style="background: #F5FAF7; padding: 0.6rem; border-radius: 10px; border: 1px solid #ECFDF5; display: flex; flex-direction: column; justify-content: center; min-height: 52px;">
                            <div style="font-size: 1.15rem; font-weight: 800; color: #0891b2; line-height: 1.1;" id="statPrograms">⏳</div>
                            <div style="font-size: 0.55rem; color: #64756A; font-weight: 700; text-transform: uppercase; margin-top: 4px; letter-spacing: 0.02em;">Programs</div>
                        </div>
                        <div style="background: #F5FAF7; padding: 0.6rem; border-radius: 10px; border: 1px solid #ECFDF5; display: flex; flex-direction: column; justify-content: center; min-height: 52px;">
                            <div style="font-size: 1.15rem; font-weight: 800; color: #059669; line-height: 1.1;" id="statJudges">⏳</div>
                            <div style="font-size: 0.55rem; color: #64756A; font-weight: 700; text-transform: uppercase; margin-top: 4px; letter-spacing: 0.02em;">Judges</div>
                        </div>
                        <div style="background: #F5FAF7; padding: 0.6rem; border-radius: 10px; border: 1px solid #ECFDF5; display: flex; flex-direction: column; justify-content: center; min-height: 52px;">
                            <div style="font-size: 1.15rem; font-weight: 800; color: #F59E0B; line-height: 1.1;" id="statTeams">⏳</div>
                            <div style="font-size: 0.55rem; color: #64756A; font-weight: 700; text-transform: uppercase; margin-top: 4px; letter-spacing: 0.02em;">Teams</div>
                        </div>
                        <div style="background: #F5FAF7; padding: 0.6rem; border-radius: 10px; border: 1px solid #ECFDF5; display: flex; flex-direction: column; justify-content: center; min-height: 52px;">
                            <div style="font-size: 1.15rem; font-weight: 800; color: #047857; line-height: 1.1;" id="statCategories">⏳</div>
                            <div style="font-size: 0.55rem; color: #64756A; font-weight: 700; text-transform: uppercase; margin-top: 4px; letter-spacing: 0.02em;">Categories</div>
                        </div>
                        <div style="background: #F5FAF7; padding: 0.6rem; border-radius: 10px; border: 1px solid #ECFDF5; display: flex; flex-direction: column; justify-content: center; min-height: 52px;">
                            <div style="font-size: 1.15rem; font-weight: 800; color: #e11d48; line-height: 1.1;" id="statResults">⏳</div>
                            <div style="font-size: 0.55rem; color: #64756A; font-weight: 700; text-transform: uppercase; margin-top: 4px; letter-spacing: 0.02em;">Results</div>
                        </div>
                    </div>
                </div>
        ...
        snapshot.forEach((docSnap) => {
            ...
            tableRows += `
                <tr>
                    ...
                    <td>${dateStr}</td>
                    <td>
                        <span class="badge" style="background:#fef3c7; color:#F59E0B; border:1px solid #fde68a; font-size:0.7rem;">Pending</span>
                    </td>
                    <td style="text-align: right;">
