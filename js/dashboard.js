...
function toggleChartEmptyState(containerId, isEmpty) {
    ...
    if (isEmpty) {
        if (!emptyOverlay) {
            ...
            emptyOverlay.style.cssText = 'position:absolute; top:0; left:0; width:100%; height:100%; display:flex; align-items:center; justify-content:center; background:rgba(255,255,255,0.85); z-index:10; font-weight:600; color:#64756A; font-size:0.95rem; border-radius:14px;';
...
function getCategoryColor(categoryName, index) {
    ...
    if (name.includes('junior')) return '#059669'; // Purple
    if (name.includes('senior')) return '#059669'; // Green
...
function updateCharts(teamLabels, teamData, catLabels, catData) {
    ...
    const gradients = [];
    const gradientStops = [
        { start: '#047857', end: '#C084FC' }, // Team A: Purple → Violet
        { start: '#3B82F6', end: '#06B6D4' }, // Team B: Blue → Cyan
        { start: '#059669', end: '#34D399' }, // Team C: Emerald → Green
        { start: '#F59E0B', end: '#FBBF24' }, // Amber → Yellow
        { start: '#EC4899', end: '#F472B6' }, // Pink
        { start: '#059669', end: '#10B981' }  // Indigo
    ];
...
function recalculateDashboard() {
    ...
    if (leaderboardBody) {
        ...
        if (sortedTeams.length === 0) {
            newHTML = `<tr><td colspan="3" style="text-align:center; padding:2rem; color:#64756A; font-style:italic;">No points recorded yet.</td></tr>`;
        } else {
            newHTML = sortedTeams.map(({ name, points }, idx) => {
                ...
                else rankHTML = `<span style="font-weight: 700; color: #64756A; font-size: 0.85rem;">#${idx + 1}</span>`;

                return `
                    <tr style="border-bottom:1px solid #ECFDF5; transition: all 0.2s;">
                        <td style="padding:0.85rem 0.5rem; text-align:center;">${rankHTML}</td>
                        <td style="padding:0.85rem 0.5rem; font-weight:700; color:#17251B; max-width:160px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
                            ${window.escapeHTML(name)}
                        </td>
                        <td style="padding:0.85rem 0.5rem; text-align:right; font-weight:800; color:#047857;">
                            ${points} pts
                        </td>
                    </tr>
                `;
    ...
    if (statusEl) {
        const newStatusHTML = hasPublished 
            ? `<span style="color:#059669; font-weight:700; display:flex; align-items:center; gap:4px;">✓ Public Portal Active (${publishedCount} results)</span>`
...
async function initDashboardOverview(container, topActions) {
    ...
    container.innerHTML = `
        <div class="dashboard-overview-container">
            ...
            <div class="dashboard-summary-cards">
                ...
                <div class="card stat-card-premium">
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <div class="stat-card-icon-container" style="background: rgba(4, 120, 87, 0.08);">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" style="color:#047857;">
                ...
                <div class="card stat-card-premium">
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <div class="stat-card-icon-container" style="background: rgba(5, 150, 105, 0.08);">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" style="color:#059669;">
                ...
                <div class="card stat-card-premium">
                    <div style="display:flex; justify-content:space-between; align-items:center;">
                        ...
                        <div class="stat-card-icon-container" style="background: rgba(100, 116, 139, 0.08);">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" style="color:#64756A;">
            ...
            <div class="dashboard-main-grid">
                ...
                <div class="charts-section">
                    ...
                    <div class="card chart-card" id="radarContainer">
                        <h3 style="font-size:1.05rem; font-weight:800; color:#17251B; margin-top:0; margin-bottom:1.25rem; display:flex; align-items:center; gap:0.5rem; font-family:'Outfit',sans-serif;">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="width:1.2rem; height:1.2rem; color:#047857;"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5H21A7.5 7.5 0 0 0 13.5 3v7.5Z" /></svg>
                ...
                <div class="leaderboard-section">
                    ...
                    <div class="card" style="padding:1.75rem; border-radius:20px; border-color:#D8E8DE; box-shadow:0 10px 30px -10px rgba(23, 37, 27, 0.04);">
                        <h3 style="font-size:1.05rem; font-weight:800; color:#17251B; margin-top:0; margin-bottom:0.2rem; display:flex; align-items:center; gap:0.5rem; font-family:'Outfit',sans-serif;">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="width:1.2rem; height:1.2rem; color:#047857;"><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.504-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 0 1-.982-3.172M9.497 0a7.454 7.454 0 0 0 .981 3.172M8.312 14.375a6.002 6.002 0 0 1-2.813-5.326m13.002 0a6.002 6.002 0 0 1-2.813 5.326M5.499 9.049a3.75 3.75 0 0 1 2.812-4.673M18.501 9.049a3.75 3.75 0 0 0-2.812-4.673M12 2.25A2.25 2.25 0 0 0 9.75 4.5v1.25a2.25 2.25 0 0 0 4.5 0V4.5A2.25 2.25 0 0 0 12 2.25z" /></svg>
                            Team Leaderboard
                        </h3>
                        <p style="font-size:0.75rem; color:#64756A; margin-bottom:1rem; font-weight:500;">Standings aggregated from published results.</p>
                        <div style="overflow-x:auto;">
                            <table style="width:100%; border-collapse:collapse; font-size:0.875rem;">
                                <thead>
                                    <tr style="border-bottom:2px solid #D8E8DE; text-align:left; background:#F5FAF7;">
                                        <th style="padding:0.6rem 0.5rem; color:#64756A; font-weight:700; width:70px; text-align:center; font-size:0.7rem; letter-spacing:0.04em;">RANK</th>
                                        <th style="padding:0.6rem 0.5rem; color:#64756A; font-weight:700; font-size:0.7rem; letter-spacing:0.04em;">TEAM NAME</th>
                                        <th style="padding:0.6rem 0.5rem; color:#64756A; font-weight:700; text-align:right; width:80px; font-size:0.7rem; letter-spacing:0.04em;">POINTS</th>
                                    </tr>
                                </thead>
                                <tbody id="leaderboardBody">
                                    <tr><td colspan="3" style="text-align:center; padding:1.5rem; color:#64756A;"><span class="spinner-sm"></span> Loading standings...</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
            ...
            <div class="card public-portal-card" style="border: 1px solid rgba(4, 120, 87, 0.15); background: linear-gradient(135deg, rgba(4, 120, 87, 0.02) 0%, rgba(59, 130, 246, 0.02) 100%); padding: 2rem; border-radius: 20px; box-shadow: 0 10px 30px -10px rgba(23, 37, 27, 0.04); margin-top: 1rem;">
                <div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; gap: 2rem; flex-wrap: wrap;">
                    ...
                    <div style="flex: 1; min-width: 280px;">
                        <h3 class="card-title" style="color: #047857; font-weight: 800; font-family: 'Outfit', sans-serif; display: flex; align-items: center; gap: 0.5rem; font-size: 1.25rem; margin-bottom: 0.5rem;">
                        ...
                        <p style="font-size: 0.9rem; color: #64756A; margin-bottom: 0.5rem; line-height: 1.5; font-weight: 500;">
                            Share published standings instantly with parents and students. Results auto-sync in real-time.
                        </p>
                        <p style="font-size: 0.8rem; color: #64756A; margin-bottom: 0.5rem; font-style: italic; opacity: 0.9;">
                    ...
                    <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
                        ...
                        <button class="btn btn-outline" id="dashOpenPortal" style="border-radius: 10px; font-weight: 700; padding: 0.75rem 1.5rem; display: flex; align-items: center; gap: 0.5rem; border-color: #047857; color: #047857;">
                            🌐 Open Portal
                        </button>
                    </div>
            ...
            <div class="card public-hub-card" style="border: 1px solid rgba(5, 150, 105, 0.25); background: linear-gradient(135deg, rgba(5, 150, 105, 0.03) 0%, rgba(6, 182, 212, 0.03) 100%); padding: 2rem; border-radius: 20px; box-shadow: 0 10px 30px -10px rgba(23, 37, 27, 0.04); margin-top: 1rem;">
                <div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; gap: 2rem; flex-wrap: wrap;">
                    ...
                    <div style="flex: 1; min-width: 280px;">
                        ...
                        <p style="font-size: 0.9rem; color: #64756A; margin-bottom: 0px; line-height: 1.5; font-weight: 500;">
                            View Official Results, Team Standings and Category Rankings.
                        </p>
                    </div>
                    ...
                    <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
                        ...
                        <button class="btn btn-primary" id="dashOpenPublicHub" style="background: linear-gradient(135deg, #059669 0%, #059669 100%); border: none; border-radius: 10px; font-weight: 700; padding: 0.75rem 1.5rem; display: flex; align-items: center; gap: 0.5rem; color: white;">
                            📱 Open Public Results
                        </button>
                    </div>
            ...
            <div class="card live-display-card" style="border: 1px solid rgba(217, 119, 6, 0.25); background: linear-gradient(135deg, rgba(217, 119, 6, 0.03) 0%, rgba(234, 88, 12, 0.03) 100%); padding: 2rem; border-radius: 20px; box-shadow: 0 10px 30px -10px rgba(23, 37, 27, 0.04); margin-top: 1rem;">
                <div style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; gap: 2rem; flex-wrap: wrap;">
                    
                    <!-- Left: Description -->
                    <div style="flex: 1; min-width: 280px;">
                        <h3 class="card-title" style="color: #F59E0B; font-weight: 800; font-family: 'Outfit', sans-serif; display: flex; align-items: center; gap: 0.5rem; font-size: 1.25rem; margin-bottom: 0.5rem;">
                    ...
                    <!-- Right: Actions Grid -->
                    <div style="display: flex; align-items: center; gap: 0.75rem; flex-wrap: wrap;">
                        <button class="btn btn-outline" id="dashCopyLiveLink" style="border-radius: 10px; font-weight: 600; padding: 0.75rem 1.25rem; display: flex; align-items: center; gap: 0.5rem; border-color: #F59E0B; color: #F59E0B;">
                            🔗 Copy Display Link
                        </button>
                        <button class="btn btn-primary" id="dashOpenLiveDisplay" style="background: linear-gradient(135deg, #F59E0B 0%, #F59E0B 100%); border: none; border-radius: 10px; font-weight: 700; padding: 0.75rem 1.5rem; display: flex; align-items: center; gap: 0.5rem; color: white;">
                            📺 Open Live Display
                        </button>
                    </div>
